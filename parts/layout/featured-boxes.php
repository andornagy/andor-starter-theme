		...
		<div class="grid-x grid-padding-x grid-padding-y">
		    ...
		    while( have_rows('boxes') ) : the_row();
		       ...
		       $page = get_sub_field('page');
		        ...
		        if (get_sub_field('heading')) { $heading = get_sub_field('heading'); }
			        $image = get_sub_field('image');
			        if ($image) {
				       $imgurl = $image['sizes']['landscape']; 
			        }
			        
		        if (get_sub_field('external_link')) { $link = get_sub_field('external_link'); }
		    ...
		    <div class="cell medium-4">
				<a href="<?php echo $link; ?>" title="<?php echo $heading; ?>">
				    <div class="card">
					  ...
					  <?php 
						  if ($imgurl) { echo '<img src="'.$imgurl.'" alt="'.$heading.'" />'; }
					  ?>
