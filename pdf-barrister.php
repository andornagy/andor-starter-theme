...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/custom.css?<?php echo filemtime(get_template_directory() . '/assets/css/custom.css'); ?>" type="text/css" media="all">
